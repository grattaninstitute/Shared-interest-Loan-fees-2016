...
High income graduates who repay quickly would more than cover their interest costs, and would cross-subsidise the cost of low-income graduates who repay more slowly.
...
The amount of new borrowings each year under the \gls{HECS} scheme has grown five-fold over 20~years. Participation in undergraduate and post-graduate education has increased, students on average borrow more, and the scheme has been expanded to cover \abbrev{VET}.
...
\begin{figure}
\vspace{\grattanfptopminustextheight}
...
Unlike charging real interest, \gls{Loan fees} would cap extra repayment to their real values, as \Vref{fig:fig22-extra-repayment-capped-at-real-level-of-loan-fee} shows.
...
Any shift to paying upfront is likely to be small, especially among undergraduate students, as \Cref{are-loan-fees-consistent-with-helps-principles} discusses.
