...
\section[CPI compared to the government's cost of borrowing]{\gls{CPI} versus the government's cost of borrowing}\label{sec:cpi-versus-the-governments-cost-of-borrowing}
...
As noted in \Cref{sec:interest-subsidies-by-gender}, interest subsidies are zero for debtors not expected to repay because their cost is included in \gls{Doubtful debt}.
