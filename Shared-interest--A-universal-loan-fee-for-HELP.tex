...
\units{\Gls{Interest subsidy} to the median graduate; Median lifetime earnings; Per cent original borrowing \$2016~million}
...
\units{\Gls{Interest subsidy} per cent of original borrowing by income level }
...
Reducing interest subsidies is a better means than the alternatives to contribute to budget repair. The alternatives may reduce access to higher education or interfere with future income smoothing.

\section[HELP and risk management]{\gls{HELP} and risk management}\label{help-and-risk-management}

Interest subsidies are not needed to promote participation in higher education.
...
Recouping the cost of interest subsidies would not affect \gls{HELP}'s ability to minimise default risks as long as it keeps the current income-contingent repayment collection system.
...
Interest subsidies are also not needed to smooth living standards over a lifetime.
...
But ver low \gls{Threshold}s might impede \gls{HELP}'s goals of supporting access to higher education and smoothing lifetime incomes.
...
but the proposal was widely criticised.
...
In a hybrid system, a person with a high income in a year is charged the real interest rate on outstanding debt.
...
While charging real interest on \gls{HELP} loans could provide significant savings, it was widely criticised.
...
A male graduate earning at the 30{th} percentile would repay over 20~per cent more than his original borrowing, while a male graduate earning at the 90th percentile would repay less than 10~per cent of his original loan.
...
\section[Impact of charging real interest on \abbrev{HELP}'s principles]{Impact of charging real interest on \gls{HELP}'s principles} \label{how-would-the-real-interest-model-and-the-hybrid-model-affect-helps-principles}
...
Rather than charging real interest, government should extend existing \gls{Loan fees} across all loan programs.
...
Extending \gls{Loan fees} would both reduce inconsistencies among programs and reduce \gls{HELP} cost.
...
Because \gls{Doubtful debt} is partly a consequence of government social policy, \gls{Loan fees} should not aim to recover it (\Vref{box:box2-should-loan-fees-cover-interest-subsides-doubtful-debt}).
...
Potential increase includes 50~per cent of potential \gls{Loan fees} from students in government-subsidised courses borrowing through \gls{VETFEEHELP}\@.
...
\Vref{fig:fig24-a-15pc-loan-fee-all-HELP-progs-would-improve-fisc-bal-by-over-700M-in-2016} shows an expected improvement in the Government's \gls{Fiscal balance} from a 15~per cent loan fee, after deducting reduced revenue from existing \gls{Loan fees}.
