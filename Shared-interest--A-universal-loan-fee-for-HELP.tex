...
Since its introduction in 1989, HECS and subsequently \gls{HELP} loans have been indexed to the consumer price index \gls{CPI}.
...
\footnote{Grattan analysis of ABS (2015a); RBA (2016a); RBA (2015)} The annual subsidy is estimated to grow by 20 per cent, to over \$600 million in 2015-16, largely due to rising outstanding \gls{HELP} debt.
...
\gls{HELP}, formerly known as HECS, has expanded since its introduction 27 years ago.
The most direct descendant of the original HECS scheme is \gls{HECSHELP}, which lends to Commonwealth supported students.
...
While \gls{HELP} lending has grown rapidly, repayments have not kept up, as Figure 7 shows.
...
\chapter[Does HELP need interest subsidies?]{Does \gls{HELP} need interest subsidies?}\label{chap:does-help-need-interest-subsidies}
...
HECS and then \gls{HELP} deliberately transfer financial risks from students to taxpayers.
...
Full-fee undergraduate students borrowing under \gls{FEEHELP} pay a 25 per cent loan fee while upper-level vocational qualification full-fee students borrowing through \gls{VETFEEHELP} pay 20 per cent (Figure 19).
...
Doubtful debt \gls{HELP} debt not expected to be repaid

\gls{FEEHELP} \gls{HELP} for full-fee students

Fiscal balance An accrual measure of the government's revenue less expenditure

HECS Higher Education Contribution Scheme

\gls{HECSHELP} \gls{HELP} for Commonwealth-supported students

\gls{HELP} Higher Education Loan Program

HESA Higher Education Support Act 2003

Interest subsidy Subsidies provided by the government to \gls{HELP} debtors for providing loans at a discounted interest rate

Loan fees Charges added to new outstanding debt for borrowing through \gls{HELP} to be repaid under the same repayment setting as the principal

\gls{OSHELP} \gls{HELP} to finance overseas study

PAYG Pay As You Go taxation

\gls{SAHELP} \gls{HELP} for the student amenities fee

Student contribution The amount paid by a student in a Commonwealth-supported place

Threshold Income level that triggers \gls{HELP} repayment or a new rate of repayment

\gls{VETFEEHELP} \gls{HELP} for vocational education diplomas and advanced diplomas
\end{document}
