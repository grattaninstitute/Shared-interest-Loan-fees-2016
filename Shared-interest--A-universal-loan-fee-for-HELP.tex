...
To moderate the impact, the report's subsidy calculation excludes unemployed graduates and graduates who are not in the labour force.%
...
\footnote{\textcite[][section 2, table 2.6]{Education2016StudentsSelectedhigher}} Because the Census does not identify students by their \gls{HELP} program, the report calculates the subsidy based on the contribution amounts for government-supported students.
\end{smallbox}
