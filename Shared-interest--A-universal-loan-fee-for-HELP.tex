...
Since its introduction in 1989, HECS and subsequently HELP loans have been indexed to the consumer price index \gls{CPI}.
...
The actual annual interest cost represents a lower bound since the government does not immediately index HELP lending to \gls{CPI}, the interest cost on new lending would include both \gls{CPI} and real interest.
See footnote 68}%
...
\footnote{See notes for \Vref{fig:fig1-annual-interest-subsidy-is-low-compared-to-when-the-real-interest-rate-was-at-its-10-year-hist-avg}, ABS (2015a); RBA (2016a); RBA (2015).
...
In that year, just over 300,000 places were available for HECS students, as \Vref{fig:fig3-number-govt-supported-students-doubled-since-1989} shows.\afterpage{\cleardoublepage} %
...
\units{\gls{FEEHELP} borrowers (EFTSL)}
...
In addition to government-supported students, HELP also lends to fee-paying postgraduate and undergraduate students through \gls{FEEHELP}.
...
As with HECS-HELP, \gls{FEEHELP} lending increases are greater than the growth in borrowers would suggest.
...
Rapid growth in \gls{FEEHELP} lending falls far short of the unprecedented growth in VET \gls{FEEHELP}.
...
\footnote{Senate Education and Employment References Committee (2015)} In 2015, more than a quarter of a million students accessed VET \gls{FEEHELP}, up from about 5000 students in 2009.%
\footnote{Ryan (2016), p. 14} Many of these students will never complete their qualification.%
\footnote{NCVER (2015)} Yet the growth in borrowers cannot solely explain increases in VET \gls{FEEHELP} lending.

Diploma courses are more expensive than they were in 2009.
The growth in course fees has led to increases in how much VET \gls{FEEHELP} students borrow.
...
Reforms to VET \gls{FEEHELP} have decreased malpractice.
Lending is expected to reduce by 45 per cent, to about \$1.6 billion in 2016.
From 2017 the government plans to replace VET \gls{FEEHELP} with a new loan scheme program -- VET Student Loans.
...
The Australian Competition and Consumer Commission (ACCC) has taken separate legal action under trade practices law against several VET \gls{FEEHELP} providers: ACCC (2015).
Birmingham (2016)}

Together HELP programs are expected to lend about \$8 billion in 2016 -- nearly twice the amount lent five years ago, as \Vref{fig:fig4-more-students-higher-fees-are-pushing-up-HELP-lending} shows.%
...
\footnote{Including students who defer a portion of their fees and pay for the rest upfront through both HECS-HELP and \gls{FEEHELP}.
...
Most VET \gls{FEEHELP} borrowers pay a 20 per cent loan fee.
VET \gls{FEEHELP} borrowers in government-subsidised courses pay no loan fees while those who pay full-fees do.
...
More than 13 per cent of VET \gls{FEEHELP} eligible students paid upfront in 2014.%
...
VET \gls{FEEHELP} debtors voluntarily repay at less than half the \gls{FEEHELP} rate, at nearly 4 per cent.%
...
While the 2011 Census data predate the key growth period of VET \gls{FEEHELP} lending, they are the best source of publicly available information.
...
A real interest rate of 1.9 per cent is assumed which represents the average over ten years.
VET \gls{FEEHELP} borrowing excludes loan fees.
The calculation does not account for the lower threshold from 2018-19 as part of the Budget Savings (Omnibus) Bill 2016.}
...
Full-fee undergraduate students borrowing under \gls{FEEHELP} pay a 25 per cent loan fee while upper-level vocational qualification full-fee students borrowing through VET \gls{FEEHELP} pay 20 per cent (Figure 19).
...
The loan fee rate for full-fee paying VET \gls{FEEHELP} is shown.
These students represent 96 per cent of VET \gls{FEEHELP} students in 2016.
The government proposes abolishing VET \gls{FEEHELP} and replacing it with VET Students Loans from the start of 2017.}
\end{figure}
...
\footnote{Bradley (2008), p. 167-168} It also seems implied in the arrangements to exempt students in government-subsidised training places from VET \gls{FEEHELP} loan fees.%
...
\footnote{See Ryan (2016) for reforms implemented to reduce malpractice among VET \gls{FEEHELP} providers.
...
In 2016 these VET \gls{FEEHELP} and undergraduate \gls{FEEHELP} students are expected to incur about \$440 million in loan fees.
...
The 2016 VET \gls{FEEHELP} lending is expected to be 45 per cent less than the 2015 level (\$2.9 billion).
Potential increase includes 50 per cent of potential loan fees from students in government-subsidised courses borrowing through VET \gls{FEEHELP}.
...
Current \gls{FEEHELP} undergraduate students and VET \gls{FEEHELP} borrowers pay 25 and 20 per cent in loan fees respectively.
...
\footnote{This includes 50 per cent of loan fees from VET \gls{FEEHELP} lending to students in government-subsidised courses.
...
\gls{AWE} Average weekly earnings

\gls{CPI} Consumer Price Index
...
\gls{FEEHELP} HELP for full-fee students
...
VET \gls{FEEHELP} HELP for vocational education diplomas and advanced diplomas
\end{document}
...
\protect\hypertarget{_ENREF_23}{}{}Department of Education and Training (2014) \emph{VET \gls{FEEHELP} statistical report}, Department of Education and Training from https://www.education.gov.au/vet-fee-help-statistics

\protect\hypertarget{_ENREF_24}{}{}Department of Education and Training (2015a) \emph{2014 VET \gls{FEEHELP} enrolment tables}, Department of Education and Training from https://docs.education.gov.au/node/38377
...
\protect\hypertarget{_ENREF_58}{}{}NCVER (2015) \emph{A preliminary analysis of the outcomes of students assisted by VET \gls{FEEHELP}}, National Centre for Vocational Education Research
...
\protect\hypertarget{_ENREF_71}{}{}Ryan, S. (2016) \emph{Redesigning VET \gls{FEEHELP}: Discussion paper}, Department of Education and Training from https://docs.education.gov.au/system/files/doc/other/redesigning\_vet\_fee-help\_-\_discussion\_paper\_0\_0.pdf
