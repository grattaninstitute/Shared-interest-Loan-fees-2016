...
The difference between these two present values represents the expected interest subsidy: \textcite[][Appendix~A]{Consulting2013PrivatisationHECSdebt}.}
...
The longer their income takes to reach the threshold, the higher the interest subsidies.
...
At present debtors who earn at the initial threshold repay 4~per cent of income.
...
Since \gls{HELP}'s repayment is income-contingent, debtors are not required to repay if their income falls below the threshold.
...
Since 2004-05, about \$650,000 of \gls{HELP} debt has been waived: \textcite[][38]{ANAO2016AdministrationHigherEducation}.} Grattan Institute's 2014 report, \emph{Doubtful debt} argues that debt not expected to be repaid, commonly known as doubtful debt, should be reduced.
...
The change could significantly reduce doubtful debt.
