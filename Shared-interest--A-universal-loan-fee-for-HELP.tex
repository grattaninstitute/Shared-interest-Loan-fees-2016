...
\units{Upfront payment (per cent of total student contributions); upfront discount rate (per cent)}
...
\units{Voluntary repayment (per cent of total repayment); voluntary bonus rate (per cent of repayment)}
...
\units{Interest subsidies to the median bachelor degree graduate (per cent of original borrowing); median lifetime earnings (\$2016)}
...
\Vref{fig:fig9-relationship-expected-earnings-interest-subsides-to-median-students-weak} shows the expected interest subsidies to median working graduates by their field of education. There is not much variation between courses. While lifetime incomes affect the subsidy, so do course lengths and course fees.
...
\units{Interest subsidies to bachelor degree graduates; per cent of original borrowing by income level}
...
Reducing interest subsidies by imposing a loan fee would not endanger these features of \gls{HELP}\@. It is a better means than the alternatives to contribute to budget repair, which could reduce access to higher education.
...
\protect\hypertarget{_Ref435627338}{}{}But in practice the method of recovering interest subsidies matters.
...
\footnote{Summarised at \textcite[][p. 12]{Warburton2016ResourcingAustraliastertiary}.}
In the May 2014 Budget, the Abbott government announced further savings, including reducing student tuition subsidies by an average 20~per cent on average.
...
\footnote{\textcite[][57]{Education2016Portfoliobudgetstatements}} They were both vulnerable because their funding depended on ministerial discretion.
...
It would impose higher costs on people who spent time out of the workforce, often women with young children.
...
But it would collect less than a loan fee, and would be complex to administer.
...
\footnote{Since 2001, the difference in interest rate on NZ student loans and the Australian government's 10-year bond rate ranges between 1 to 3~per cent.} While most undergraduate students may not have money to pay upfront, many postgraduate students do (see \Cref{subsec:little-incentive-to-pay-upfront}).
...
Universities Australia, the Group of Eight and Regional Universities Network all condemned the reform as regressive.%
...
\begin{figure}[t]\vspace{1pt}
\caption{Under the real interest system, low-income graduates pay more interest than their high-income counterparts}\label{fig:fig13-under-real-interest-low-income-grads-pay-more-interest-than-high-income-counterparts}
...
\begin{minipage}[t][\textheight]{\columnwidth}
\vspace{\grattanfptop}
\caption{When real interest is imposed, graduates in low-income fields pay significantly more than graduates in high-income fields}\label{fig:fig14-when-real-interest-imposed-many-low-income-grads-pay-signif-more-than-high-income-grads}
...
\units{Extra \gls{HELP} repayment above original borrowing for a median female graduate under real interest; per cent}
...
Low-income humanities graduates would be particularly affected, as \Vref{fig:fig14-when-real-interest-imposed-many-low-income-grads-pay-signif-more-than-high-income-grads} shows.%
...
The effect of real interest compounds the longer the time out of the workforce.
...
Having different interest rates would create additional administrative burdens for the Australian Tax Office and Department of Education and Training.%
...
\Gls{Loan fees} continue to protect students from the compounding effect of real interest.

\Gls{Loan fees} should only try to recover the interest subsidy, not the costs of doubtful debt.
The students who pay \gls{Loan fees} are not responsible for doubtful debt, and should not pay for it.

Government should extend existing \gls{Loan fees} to be consistent across all loan programs. Loan fees should be charged at a universal rate of 15 per cent on the initial borrowing. The outstanding principal and loan fee should then be indexed at \gls{CPI}.

With such a loan fee, the median working bachelor graduate is likely to repay their higher education loan for an extra year. The universal fee would improve the Commonwealth's budget balance by about \$700 million a year. 

\section{Current loan~fees}\label{sec:current-loan-fees}

\Gls{Loan fees} are a long-established part of \gls{HELP}\@, but they are charged inconsistently.
...
\Gls{Loan fees} might cover both interest subsidies and \gls{Doubtful debt}.
...
Unlike charging real interest, \gls{Loan fees} would cap extra repayment to the real value of the loan fee, as \Vref{fig:fig22-extra-repayment-capped-at-real-level-of-loan-fee} shows.
...
\Vref{fig:fig24-a-15pc-loan-fee-all-HELP-progs-would-improve-fisc-bal-by-over-700M-in-2016} shows that a 15 per cent loan fee would improve the Government's \gls{Fiscal balance} by about \$700~million in 2016, after deducting reduced revenue from existing \gls{Loan fees}.
...
\begin{minipage}[t][\textheight]{\columnwidth}
\vspace{\grattanfptop}
\caption{A 15~per cent loan fee on all \gls{HELP} programs would have improved the fiscal balance by over \$700~million in 2016}\label{fig:fig24-a-15pc-loan-fee-all-HELP-progs-would-improve-fisc-bal-by-over-700M-in-2016}
